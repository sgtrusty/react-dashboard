...
const CustomerPieChart: React.FC = ({labels, series} : {labels: string[], series: number[]}) => {
  ...
  if (legendMap.length == 0) {
    return (
      <>
        <div className="flex items-center justify-center h-64 mb-4 mb-12 rounded dark:bg-gray-700">
        ...
        <div className="flex items-center mt-4">
          <div className="flex-1 me-3 ">
              <div className="h-2.5 bg-gray-200 rounded-full dark:bg-boxdark flex-1 mb-2"></div>
              <div className="h-2.5 bg-gray-200 rounded-full dark:bg-boxdark flex-1 mb-2"></div>
          </div>
          <div className="flex-1 me-3 ">
              <div className="h-2.5 bg-gray-200 rounded-full dark:bg-boxdark flex-1 mb-2"></div>
